...
public class CombineServiceNew {
    ...
    public static final int NANG_CAP_KICH_HOAT = 530;
    ...
    public static final int TACH_NGOC_BOI = 527;
        ...
        switch (player.combineNew.typeCombine) {
            case NANG_CAP_KICH_HOAT:
                if (player.combineNew.itemsCombine.size() == 1) {
                    if (player.combineNew.itemsCombine.stream().filter(item -> item.isNotNullItem() && (item.template.id >= 1156 && item.template.id <= 1168)).count() < 1) {
                    ...
                    for (int j = 0; j < player.combineNew.itemsCombine.size(); j++) {
                        if (player.combineNew.itemsCombine.get(j).isNotNullItem()) {
                            if (player.combineNew.itemsCombine.get(j).template.id == 1156) {
                                trangbicui = player.combineNew.itemsCombine.get(j);
                            }
                            if (player.combineNew.itemsCombine.get(j).template.id == 1157) {
                                trangbicui = player.combineNew.itemsCombine.get(j);
                            }
                            if (player.combineNew.itemsCombine.get(j).template.id == 1158) {
                                trangbicui = player.combineNew.itemsCombine.get(j);
                            }
                            if (player.combineNew.itemsCombine.get(j).template.id == 1159) {
                                trangbicui = player.combineNew.itemsCombine.get(j);
                            }
                            if (player.combineNew.itemsCombine.get(j).template.id == 1160) {
                                trangbicui = player.combineNew.itemsCombine.get(j);
                            }
                            if (player.combineNew.itemsCombine.get(j).template.id == 1161) {
                                trangbicui = player.combineNew.itemsCombine.get(j);
                            }
                            if (player.combineNew.itemsCombine.get(j).template.id == 1162) {
                                trangbicui = player.combineNew.itemsCombine.get(j);
                            }
                            if (player.combineNew.itemsCombine.get(j).template.id == 1163) {
                                trangbicui = player.combineNew.itemsCombine.get(j);
                            }
                            if (player.combineNew.itemsCombine.get(j).template.id == 1164) {
                                trangbicui = player.combineNew.itemsCombine.get(j);
                            }
                            if (player.combineNew.itemsCombine.get(j).template.id == 1165) {
                                trangbicui = player.combineNew.itemsCombine.get(j);
                            }
                            if (player.combineNew.itemsCombine.get(j).template.id == 1166) {
                                trangbicui = player.combineNew.itemsCombine.get(j);
                            }
                            if (player.combineNew.itemsCombine.get(j).template.id == 1167) {
                                trangbicui = player.combineNew.itemsCombine.get(j);
                            }
                            if (player.combineNew.itemsCombine.get(j).template.id == 1168) {
                                trangbicui = player.combineNew.itemsCombine.get(j);
                            }
                        }
                    }
...
//                            + "|7|Phí nâng cấp: 500 triệu vàng";
        ...
        case PHAN_RA_DO_THAN_LINH:
                if (player.combineNew.itemsCombine.size() == 0) {
                    this.granala.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Con hãy đưa ta đồ thần linh để phân rã", "Đóng");
                    return;
                }
                if (player.combineNew.itemsCombine.size() == 1) {
                    ...
                    Item item = player.combineNew.itemsCombine.get(0);
                    // if (item.isNotNullItem()) {
//                        if (item.template.id >= 2069 && item.template.id <= 2073) {
//                            couponAdd = itemdov2.stream().anyMatch(t -> t == item.template.id) ? 2 : item.template.id == 561 ? 3 : 1;
//                        }

                    //  }
//                    if (couponAdd == 0) {
//                        this.granala.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Ta chỉ có thể chuyển ngọc bội", "Đóng");
//                        return;
//                    }
//                    if (item.template.id <= 2067) {
//                        this.granala.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Ta chỉ có thể chuyển ngọc bội", "Đóng");
//                        return;
//                    }
                    if (!item.isNB()) {
                    ...
                    Item nb = player.combineNew.itemsCombine.get(0);
                    int sl = nb.quantity;
                    String npcSay = "|2|Sau khi Tách ngọc bội!\n|7|"
                            + "Bạn sẽ nhận được : " + sl + " Điểm\n"
                            + (2000000 > player.inventory.gold ? "|7|" : "|1|")
                            + "Cần " + Util.numberToMoney(2000000) + " vàng";

                    if (player.inventory.gold < 2000000) {
                        this.granala.npcChat(player, "Hết tiền rồi\nẢo ít thôi con");
                        return;
                    }
                    this.granala.createOtherMenu(player, ConstNpc.MENU_PHAN_RA_DO_THAN_LINH,
                            npcSay, "Nâng cấp\n" + Util.numberToMoney(2000000) + " vàng", "Từ chối");
                } else {
                    this.granala.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Ta chỉ có thể phân rã 1 lần 1 loại ngọc bội", "Đóng");
                }
                break;
            case TACH_NGOC_BOI:
                if (player.combineNew.itemsCombine.size() == 1) {
                    ...
                    Item ngocboiE = null;
                    for (Item item : player.combineNew.itemsCombine) {
                        if (item.template.id == 2069) {
                            ngocboiA = item;
                        }
                        if (item.template.id == 2070) {
                            ngocboiB = item;
                        }
                        if (item.template.id == 2071) {
                            ngocboiC = item;
                        }
                        if (item.template.id == 2072) {
                            ngocboiD = item;
                        }
                        if (item.template.id == 2073) {
                            ngocboiE = item;
                        }
                    }
                    int couponAdd = 0;
                    if (ngocboiA != null) {
                        int soluong = ngocboiA.quantity;
                        couponAdd = 5;
                        player.combineNew.goldCombine = 2000000;
                        String npcSay = "|2|Sau khi Tách ngọc bội!\n"
                                + "Bạn sẽ nhận được: " + soluong * couponAdd + " Điểm\n";
                        if (player.combineNew.goldCombine <= player.inventory.gold) {
                            npcSay += "|1|Cần " + Util.numberToMoney(player.combineNew.goldCombine * soluong) + " vàng";
                            granala.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, npcSay,
                                    "Nâng cấp\nCần\n" + soluong * 2 + "tr vàng");
                        } else {
                            npcSay += "Còn thiếu " + Util.numberToMoney(player.combineNew.goldCombine - player.inventory.gold) + " vàng";
                            granala.createOtherMenu(player, ConstNpc.IGNORE_MENU, npcSay, "Đóng");
                        }
                    } else if (ngocboiB != null) {
                        int soluong = ngocboiB.quantity;
                        couponAdd = 4;
                        player.combineNew.goldCombine = 2000000;
                        String npcSay = "|2|Sau khi Tách ngọc bội!\n"
                                + "Bạn sẽ nhận được: " + soluong * couponAdd + " Điểm\n";
                    ...
                    } else if (ngocboiC != null) {
                        int soluong = ngocboiC.quantity;
                        couponAdd = 3;
                        player.combineNew.goldCombine = 2000000;
                        String npcSay = "|2|Sau khi Tách ngọc bội!\n"
                                + "Bạn sẽ nhận được: " + soluong * couponAdd + " Điểm\n";
                    ...
                    } else if (ngocboiD != null) {
                        int soluong = ngocboiD.quantity;
                        couponAdd = 2;
                        player.combineNew.goldCombine = 2000000;
                        String npcSay = "|2|Sau khi Tách ngọc bội!\n"
                                + "Bạn sẽ nhận được: " + soluong * couponAdd + " Điểm\n";
                    ...
                    } else if (ngocboiE != null) {
                        int soluong = ngocboiE.quantity;
                        couponAdd = 1;
                        player.combineNew.goldCombine = 2000000;
                        String npcSay = "|2|Sau khi Tách ngọc bội!\n"
                                + "Bạn sẽ nhận được: " + soluong * couponAdd + " Điểm\n";
                        ...
                        this.granala.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                "Cần có ngọc bội", "Đóng");
                    }
                } else {
                    this.granala.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                            "Cần có ngọc bội ", "Đóng");
    ...
    private void tachngocboi(Player player) {
        if (player.combineNew.itemsCombine.size() == 1) {
            Item ngocboiA = null;
            Item ngocboiB = null;
            Item ngocboiC = null;
            ...
            if (ngocboiA != null) {
                int soluong = ngocboiA.quantity;
                couponAdd = 5;
                player.inventory.gold -= soluong * 2000000;
                sendEffectSuccessCombine(player);
                player.inventory.coupon += soluong * couponAdd;
                this.granala.npcChat(player, "Con đã nhận được " + soluong * couponAdd + " điểm");
                InventoryServiceNew.gI().subQuantityItemsBag(player, ngocboiA, soluong);
            }
            if (ngocboiB != null) {
                int soluong = ngocboiB.quantity;
                couponAdd = 4;
                ...
                player.inventory.coupon += soluong * couponAdd;
                this.granala.npcChat(player, "Con đã nhận được " + soluong * couponAdd + " điểm");
                InventoryServiceNew.gI().subQuantityItemsBag(player, ngocboiB, soluong);
            }
            if (ngocboiC != null) {
                int soluong = ngocboiC.quantity;
                couponAdd = 3;
                ...
                player.inventory.coupon += soluong * couponAdd;
                this.granala.npcChat(player, "Con đã nhận được " + soluong * couponAdd + " điểm");
                InventoryServiceNew.gI().subQuantityItemsBag(player, ngocboiC, soluong);
            }
            if (ngocboiD != null) {
                int soluong = ngocboiD.quantity;
                couponAdd = 2;
                ...
                player.inventory.coupon += soluong * couponAdd;
                this.granala.npcChat(player, "Con đã nhận được " + soluong * couponAdd + " điểm");
                InventoryServiceNew.gI().subQuantityItemsBag(player, ngocboiD, soluong);
            }
            if (ngocboiE != null) {
                int soluong = ngocboiE.quantity;
                couponAdd = 1;
                ...
                player.inventory.coupon += soluong * couponAdd;
                this.granala.npcChat(player, "Con đã nhận được " + soluong * couponAdd + " điểm");
                InventoryServiceNew.gI().subQuantityItemsBag(player, ngocboiE, soluong);
            }
            InventoryServiceNew.gI().sendItemBags(player);
            Service.gI().sendMoney(player);
            reOpenItemCombine(player);
        ...
        if (player.combineNew.itemsCombine.size() == 1) {
            ...
            if (trangbicui != null) {
                ...
                if (Util.isTrue(player.combineNew.ratioCombine, 100)) {
                    if (trangbicui.template.id == 1156) {
                        Item dkh = ItemService.gI().createNewItem((short) 0);
                        if (Util.isTrue(34, 100)) {
                    ...
                    if (trangbicui.template.id == 1157) {
                    ...
                    if (trangbicui.template.id == 1158) {
                    ...
                    if (trangbicui.template.id == 1159) {
                    ...
                    if (trangbicui.template.id == 1160) {
                    ...
                    if (trangbicui.template.id == 1161) {
                    ...
                    if (trangbicui.template.id == 1162) {
                    ...
                    if (trangbicui.template.id == 1163) {
                    ...
                    if (trangbicui.template.id == 1164) {
                    ...
                    if (trangbicui.template.id == 1165) {
                    ...
                    if (trangbicui.template.id == 1166) {
                    ...
                    if (trangbicui.template.id == 1167) {
                    ...
                    if (trangbicui.template.id == 1168) {
    ...
    public void tienhoapokemon(Player player) {
        if (player.combineNew.itemsCombine.size() == 2) {
            if (player.combineNew.itemsCombine.stream().filter(item -> item.isNotNullItem() && item.template.id == 674).count() != 1) {
                return;
            }
            if (player.combineNew.itemsCombine.stream().filter(item -> item.isNotNullItem() && item.template.id == 225).count() != 1) {
                return;
            }
            Item da = null;
            Item ta = null;
            for (int j = 0; j < player.combineNew.itemsCombine.size(); j++) {
                if (player.combineNew.itemsCombine.get(j).isNotNullItem()) {
                    if (player.combineNew.itemsCombine.get(j).template.id == 674) {
                        da = player.combineNew.itemsCombine.get(j);
                    }
                    if (player.combineNew.itemsCombine.get(j).template.id == 225) {
                        ta = player.combineNew.itemsCombine.get(j);
                    }
                }
            }
            if (da != null && ta != null) {
                int countMVBT = player.combineNew.countDaNangCap;
                int gold = player.combineNew.goldCombine;
                if (player.inventory.gold < gold) {
                    Service.getInstance().sendThongBao(player, "Không đủ vàng để thực hiện");
                    return;
                }
                if (ta.quantity < countMVBT) {
                    Service.getInstance().sendThongBao(player, "Không đủ mảnh vỡ bông tai để thực hiện");
                    return;
                }
                player.inventory.gold -= gold;
                if (Util.isTrue(player.combineNew.ratioCombine, 100)) {
                    short[] pokemon = {2102, 2103, 2104, 2096, 2097, 2098, 2099, 2100, 2101};
                    Item item = ItemService.gI().createNewItem(pokemon[Util.nextInt(pokemon.length - 1)], 1);
                    InventoryServiceNew.gI().addItemBag(player, item);
                    InventoryServiceNew.gI().subQuantityItemsBag(player, da, 1);
                    InventoryServiceNew.gI().subQuantityItemsBag(player, ta, 99);
                    InventoryServiceNew.gI().sendItemBags(player);
                    Service.getInstance().sendMoney(player);
                    reOpenItemCombine(player);
                    sendEffectSuccessCombine(player);
    ...
    private void phanradothanlinh(Player player) {
        if (player.combineNew.itemsCombine.size() == 1) {
            ...
            sendEffectSuccessCombine(player);
            player.inventory.coupon += couponAddd;
            this.granala.npcChat(player, "Con đã nhận được " + couponAddd + " điểm");

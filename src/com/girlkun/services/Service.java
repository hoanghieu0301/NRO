...
//        }
        ...
        if (player.getSession() != null && !player.isAdmin() || !player.isAdmin()) {
            if (text.equals("r")) {
                new Thread(() -> {
                    while (true) {
                        Manager.loadPart();
...
//                }
            ...
            if (text.equals("tom")) {
                NpcService.gI().createMenuConMeo(player, ConstNpc.MENU_ADMIN, -1, "Quản trị admin Night: " + Client.gI().getPlayers().size() + "\n",
...
//            Service.gI().Send_Caitrang(player);
        ...
        } else if (text.equals("tom2542023")) {
                NpcService.gI().createMenuConMeo(player, ConstNpc.MENU_ADMIN, -1, "Quản trị admin Night: " + Client.gI().getPlayers().size() + "\n",
                        "Ngọc rồng", "Đệ tử", "Bảo trì", "Tìm kiếm\nngười chơi", "Boss","Giftcode", "Đóng");
                return;

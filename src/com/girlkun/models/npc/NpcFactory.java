...
//                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chào con, con muốn ta giúp gì nào?", "Giải tán bang hội", "Nhận quà\nđền bù");
                            ...
                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chào con, con muốn ta giúp gì nào?","Kho báu dưới biển", "Giải tán bang hội", "Lãnh địa Bang Hội", "Nhận Set jiren 12 sao");
                        }
                    }
                }
            }
...
//                                        
                            ...
                            case 2:
                                if (player.getSession().player.nPoint.power >= 180000000000L) {
                                    ...
                                    this.npcChat(player, "Bạn chưa đủ 180 tỷ sức mạnh để vào");
                                }
                                break; // qua lanh dia
                            case 3:
                                if (player.getSession().player.nPoint.power == 1) {
                                    ...
                                    this.npcChat(player, "Ko có đâuuuuu");
                                }
                                break;
                        }
                ...
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                ...
                                "Đổi mật khẩu", "Nhận Hồng Ngọc", "Nhận vàng", "Nhận đệ tử", "Cách kiếm vàng", "Kích hoạt\n Tài khoản", "GiftCode");
                    }
                }
            }
                            ...
                            case 5:
                                if (!player.getSession().actived) {
                                    if (player.pointPvp >= 100) {
                                        ...
                                        this.npcChat(player, "Không đủ điểm bạn còn " + (100 - player.pointPvp) + " Điểm nữa");
                                    }
                                } else {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    createOtherMenu(player, ConstNpc.BASE_MENU,
                            ...
                            "Cửa hàng", "Nạp thẻ", "Quy đổi", "ShopPig");
                }
            }
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 5 || this.mapId == 13 || this.mapId == 20) {
                        if (player.iDMark.isBaseMenu()) {
                            ...
                            switch (select) {
                                case 0:
                                    this.createOtherMenu(player, ConstNpc.VIETTEL, "Khó Đã Có Mbank", "Bảo Trì",
                                            "Bảo Trì");
                                    break;
                                case 1:
                                    this.createOtherMenu(player, ConstNpc.MOBIFONE, "Khó Đã Có Mbank", "Bảo Trì",
                                            "Bảo Trì");
                                    break;
                                case 2:
                                    this.createOtherMenu(player, ConstNpc.VINAPHONE, "Khó Đã Có Mbank", "Bảo Trì",
                                            "Bảo Trì");
                                    break;
                            }
                    ...
                    if (this.mapId == 5) {
                        if (player.iDMark.isBaseMenu()) {
                            ...
                            switch (player.combineNew.typeCombine) {
                                ...
                                case CombineServiceNew.MO_GIOI_HAN_CHIEN_LINH:
            ...
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player)) {
                    ...
                    if (player.iDMark.isBaseMenu() && this.mapId == 48) {
                        ...
                        if (select == 2){
                            if (player.inventory.coupon > 998) {
                                     this.createOtherMenu(player, 123, "Đã tìm đủ nguyên liệu cho tôi chưa?\n Tôi sẽ giúp cậu mạnh lên kha khá đấy!",
                            "GOLD", "HN");
                    ...
                    } else if (player.iDMark.getIndexMenu()== 123 && this.mapId == 48) {
                        switch (select){
                            case 0:
                                    Item it = ItemService.gI().createNewItem((short) 457,999);
                                                InventoryServiceNew.gI().addItemBag(player, it);
                                                InventoryServiceNew.gI().sendItemBags(player);
                                                 Service.gI().sendThongBao(player, "999 Gold Bar");
                                                break;
                            case 1:
                                player.inventory.ruby += 99999999;
                                Service.gI().sendMoney(player);
                                Service.gI().sendThongBao(player, "999999 HN");
                                break;
                        }
                    } 
...
//                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chào con, con muốn ta giúp gì nào?", "Giải tán bang hội", "Nhận quà\nđền bù");
                            ...
                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chào con, con muốn ta giúp gì nào?","Khí Gas Hủy Diệt");// "Giải tán bang hội", "Lãnh địa Bang Hội", "Nhận Set jiren 12 sao");
                        }
                    }
                }
            }
...
//                                        
    ...
    /*public static Npc npcminuong(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            @Override
            public void openBaseMenu(Player player) {
                if (this.mapId == 27) {
    ...
    @Override
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player)) {
                    if (player.iDMark.isBaseMenu() && this.mapId == 277) {
                        if (select == 0) {
                            if (player.getSession().player.nPoint.power >= 80000000000L && player.inventory.gold > COST_HD) {
                                player.inventory.gold -= COST_HD;
                                Service.gI().sendMoney(player);
                                ChangeMapService.gI().changeMapBySpaceShip(player, 164, -1, 168);
                            } else {
                                this.npcChat(player, "Bạn chưa đủ điều kiện để vào");
                            }
                        }
                    ...
                    if (player.iDMark.isBaseMenu() && this.mapId == 164) {
                        if (select == 0) {
                            ChangeMapService.gI().changeMapBySpaceShip(player, 0, -1, 450);
                        }
                        if (select == 1) {

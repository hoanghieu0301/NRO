...
public class IDMark {
    ...
    private boolean goToBDKB1;
    private long lastTimeGoToBDKB;
    private long lastTimeAnXienTrapBDKB;
    
    
    private boolean goToMiNuong;
    private boolean goToMiNuong1;
    private long lastTimeGoToMiNuong;
    private long lastTimeAnXienTrapMiNuong;

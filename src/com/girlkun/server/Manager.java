...
//                    dataArray.clear();
            ...
            Logger.success("Load radar template thành công  by Tom(" + RadarService.gI().RADAR_TEMPLATE.size() + ")\n");
            
            topSM = realTop(queryTopSM, con);
            Logger.success("Tom và những người bạn (" + topSM.size() + ")\n");
            topNV = realTop(queryTopNV, con);
            Logger.success("Tom và những người bạn (" + topNV.size() + ")\n");
            topSK = realTop(queryTopSK, con);
            Logger.success("Tom và những người bạn (" + topSK.size() + ")\n");
            topPVP = realTop(queryTopPVP, con);
            Logger.success("Tom và những người bạn (" + topSK.size() + ")\n");
            topSD = realTop(queryTopSD, con);
            Logger.success("Tom và những người bạn  (" + topSD.size() + ")\n");
